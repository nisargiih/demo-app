        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
            {[
              ...
              { 
                ...
                value: usageStats ? `${usageStats.registryCount || 0}/${usageStats.registryLimit || 5}` : '—/5', 
                icon: Archive, 
              ...
              { 
                ...
                value: usageStats ? `${usageStats.verifyCount || 0}/${usageStats.verifyLimit || 15}` : '—/15', 
                icon: ShieldCheck, 
              ...
              { 
                label: 'Index Limit', 
                value: usageStats ? `${usageStats.hashCount || 0}/${usageStats.hashLimit || 5}` : '—/5', 
                icon: Zap, 
                color: 'text-zinc-900 dark:text-white', 
