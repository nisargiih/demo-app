                ...
                {verificationStatus === 'unindexed' ? (
                  ...
                  >
                    ...
                    <p className="font-sans text-zinc-600 dark:text-zinc-400 mb-12 max-w-2xl mx-auto leading-relaxed text-2xl font-medium relative z-10">
                      The cryptographic fingerprint requested is <span className="text-red-600 font-black">completely absent</span> from the Identix sovereign substrate. This asset has no recorded origin or has been structurally compromised.
                    </p>
